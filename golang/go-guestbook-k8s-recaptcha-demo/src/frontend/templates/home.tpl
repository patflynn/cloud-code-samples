...
<body>
    <div class="header">
        <div class="container">
            ...
            <a href="https://github.com/patflynn/cloud-code-samples/tree/master/java/go-guestbook-k8s-recaptcha-demo" class="text-muted">View on GitHub</a>
        </div>
    </div>
    ...
    <div class="container posts mt-0">
        <form class="form-inline" method="POST" action="/post">
            ...
            <div class="g-recaptcha" data-sitekey="6Lc7__MUAAAAADOSlTjj9vcRzGuzMxq1Nq5Oe9PP"></div>
